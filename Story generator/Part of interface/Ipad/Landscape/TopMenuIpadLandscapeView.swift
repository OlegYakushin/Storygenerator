//
//  TopMenuIpadLandscapeView.swift
//  Story generator
//
...
struct TopMenuIpadLandscapeView: View {
    var body: some View {
        HStack{
            Button(action: {}) {
                Image("Account")
        ...
        .frame(width: 1232 * sizeScreenIpad(), height: 92 * sizeScreenIpad())
        
    }
}

struct TopMenuIpadLandscapeView_Previews: PreviewProvider {
