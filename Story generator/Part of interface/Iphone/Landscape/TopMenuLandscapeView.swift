...
struct TopMenuLandscapeView: View {
    var body: some View {
        HStack{
        ...
        .frame(width: 842 * sizeScreenIphone(), height: 55 * sizeScreenIphone())
        
    }
}

struct TopMenuLandscapeView_Previews: PreviewProvider {
