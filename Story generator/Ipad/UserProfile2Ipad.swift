...
struct UserProfile2Ipad: View {
                    ...
                    VStack{
                            ...
                            HStack{
                                ...
                                HStack(spacing: 14 * sizeScreenIpad()){
                                    VStack{
                                        Image("Trophy1")
                                            .resizable()
                                            .frame(width: 109, height: 107 * sizeScreenIpad())
                                        Text("Trophy 1")
                        ...
                        VStack{
                            ...
                            VStack{
                                Rectangle()
                                    .fill(Color.TextBlue)
                                    .frame(width: 679 * sizeScreenIpad(), height: 1)
                            }
                        }
                        .offset(x: 0, y: 00 * sizeScreenIpad())
                        Spacer()
    ...
    struct UserProfile2Ipad_Previews: PreviewProvider {
