...
struct GeneratingTheStory1: View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack{
                Image("TreasureBox")
                    .resizable()
                    .frame(width: 400 * sizeScreenIphone(), height: 225 * sizeScreenIphone())
...
struct GeneratingTheStory1_Previews: PreviewProvider {
