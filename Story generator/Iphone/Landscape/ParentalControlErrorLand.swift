//
//  ParentalControlErrorLand.swift
//  Story generator
//
...
struct ParentalControlErrorLand: View {
                ...
                HStack{
                    ...
                    VStack(alignment: .leading){
                        ...
                        Text("Please solve the following problem to continue:")
                            ...
                            .frame(width: 235 * sizeScreenIphone(), height: 36 * sizeScreenIphone())
                            .foregroundColor(Color.BlueShadow)
                            .opacity(0.7)
                            .offset(x:0,y:-50 * sizeScreenIphone())
                    ...
                    Image("Lock")
                        .resizable()
                        .frame(width: 326 * sizeScreenIphone(), height: 201 * sizeScreenIphone())
...
struct ParentalControlErrorLand_Previews: PreviewProvider {
