            ...
            ZStack{
                ...
                VStack{
                    ...
                    VStack{
                        ...
                        .offset(x: 10  * sizeScreenIpad(), y: 0)
                    ...
                    VStack{
                        HStack{
                            ...
                            Image("SignInWithApple")
                                .frame(width: 325 * sizeScreenIpad())
                            Spacer()
                            Text("Log Out")
                                .font(.custom("Baloo-Regular", size:22 * sizeScreenIpad()))
                                .foregroundColor(Color.TextBlue)
...
struct UserProfileIpad_Previews: PreviewProvider {
