...
struct AskAQuestionIpadLand: View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack{
                ...
                Text("What is your Wanna know more details about your story? about?")
            ...
            .offset(x: 0, y: -200 * sizeScreenIpad())
...
struct AskAQuestionIpadLand_Previews: PreviewProvider {
