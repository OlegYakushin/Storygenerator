    ...
    var body: some View {
        ZStack{
            RoundedRectangle(cornerRadius: 10 * sizeScreenIpad())
                    ...
                    ZStack{
                        HStack{
                            if text == "15 Stars"{
                                ...
                                .offset(x: -60 * sizeScreenIpad(), y: 0)
                ...
                .frame(width: 504 * sizeScreenIpad(), height: 202 * sizeScreenIpad())
        }
    }
}

struct StarsViewIpad_Previews: PreviewProvider {
